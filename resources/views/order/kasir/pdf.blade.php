...
<body>
    ...
    <div id="receipt">
        {{-- <a class="btn-print" href="{{ route('pembelian.download_pdf') }}">Cetak (.pdf)</a> --}}
        <center id="top">
            <div class="info">
        ...
        <p>Nama Kasir : <b>{{ Auth::user()->name }}</b></p>
        ...
        <div id="bot">
            <div id="table">
                <table>
                    ...
                    <tr class="service">
                        ...
                        <td class="tableitem"><p class="itemtext">Rp {{ $item['price'] }}</p></td>
                    </tr>
                    @endforeach
                    <tr class="tabletitle">
                        <td></td>
            ...
            <div class="info" id="mid">
                <p>Alamat: sepanjang jalan kenangan<br>
